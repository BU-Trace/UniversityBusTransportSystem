                ...
                <div className="flex items-center gap-2">
                  <div
                    className={`w-2 h-2 rounded-full ${
                      bus.status === 'running' ? 'bg-green-400 animate-pulse' : 'bg-white/60'
                    }`}
                  />
            ...
            <div className="p-3 space-y-3">
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <div className="bg-slate-50 p-2 rounded-lg border border-slate-100">
                  <p className="text-[8px] text-slate-400 font-bold uppercase mb-0.5">Speed</p>
                  <div className="flex items-baseline gap-1">
                    <span className="text-lg font-black text-slate-800">{bus.speed || 0}</span>
                    <span className="text-[9px] font-bold text-slate-500 uppercase">km/h</span>
                  </div>
                </div>

                {/* ETA */}
                <div className="bg-slate-50 p-2 rounded-lg border border-slate-100">
                  <p className="text-[8px] text-slate-400 font-bold uppercase mb-0.5">ETA</p>
